...
void BentNormalsSolver::init(std::shared_ptr<const CompressedMapUV> map, std::shared_ptr<MeshMapping> meshMapping)
{
	...
	_bentnormalsProgram = CreateComputeProgram("D:\\Code\\Fornos\\Fornos\\shaders\\bentnormals_step1.comp");
	_avgProgram = CreateComputeProgram("D:\\Code\\Fornos\\Fornos\\shaders\\bentnormals_step2.comp");
